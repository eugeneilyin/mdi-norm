...
export var TwoToneLocalFlorist =
/*#__PURE__*/
function TwoToneLocalFlorist(props) {
  return React.createElement(Icon, props, React.createElement("path", {
    ...
    d: km + "m6.68-2" + mg + "m1 5" + it + "m-2.02 2.81c.32.12.66.19 1.02.19s.71-.07 1.03-.19l.11 1.09c-.02.61-.52 1.1-1.14 1.1s-1.12-.49-1.14-1.1z" + po + "m6.56-6.56c-.71 1.9-2.22 3.42-4.12 4.12.71-1.9 2.22-3.41 4.12-4.12" + bhq
  }));
};