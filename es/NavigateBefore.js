...
export var NavigateBefore =
/*#__PURE__*/
function NavigateBefore(props) {
  return createThemedIcon(props, FilledNavigateBefore, OutlineNavigateBefore, RoundNavigateBefore, SharpNavigateBefore, TwoToneNavigateBefore);
};