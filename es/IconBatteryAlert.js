...
export var IconBatteryAlert =
/*#__PURE__*/
function IconBatteryAlert(props) {
  return createThemedIcon(props, IconBatteryAlertFilled, IconBatteryAlertOutlined, IconBatteryAlertRounded, IconBatteryAlertSharp, IconBatteryAlertTwoTone);
};