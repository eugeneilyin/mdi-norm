...
export var InvertColorsOff =
/*#__PURE__*/
function InvertColorsOff(props) {
  return createThemedIcon(props, FilledInvertColorsOff, OutlineInvertColorsOff, RoundInvertColorsOff, SharpInvertColorsOff, TwoToneInvertColorsOff);
};