...
describe('<Icon />', () => {
  ...
  test('should handle focused state', () => {
    const wrapper = shallow(<Icon state='focused'>{''}</Icon>)
    expect(wrapper.props().opacity).toEqual('.87')
  })

  test('should handle active state', () => {
    const wrapper = shallow(<Icon state='active'>{''}</Icon>)
    expect(wrapper.props().opacity).toEqual('.54')
  })

  test('should handle disabled state', () => {
    const wrapper = shallow(<Icon state='inactive'>{''}</Icon>)
    expect(wrapper.props().opacity).toEqual('.38')
  })

  test('should handle error state', () => {
    const wrapper = shallow(<Icon state='error'>{''}</Icon>)
